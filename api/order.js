...
module.exports = async function handler(req, res) {
  ...
  // [v11] public order reference (ULT-xxxxxxxx) generated by frontend — store so
  //       the customer cabinet (/order?ref=...) can locate this order later.
  const publicRef = (typeof body.num === 'string' ? body.num
                     : (body.num != null ? String(body.num) : '')).trim().slice(0, 64) || null;

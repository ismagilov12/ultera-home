...
const AGANTA_BLACK_UID = "454860479882";
const AGANTA_BLACK_PHOTO = SITE + "/photos/aganta-black-nubuck-cordura.jpg";
const AGANTA_BLACK_SUPERSEDED = [
  "https://fsihlzzjewhxpogvjapu.supabase.co/storage/v1/object/public/ulhome-media/p/1776859553465-j97nc3.jpg",
  "https://fsihlzzjewhxpogvjapu.supabase.co/storage/v1/object/public/ulhome-media/p/1776859568133-kskkyu.jpg"
];
const agantaBlack = D.find((item) => String(item.uid) === AGANTA_BLACK_UID);
if (agantaBlack) agantaBlack.ph = AGANTA_BLACK_PHOTO;
PHOTOS[AGANTA_BLACK_UID] = [AGANTA_BLACK_PHOTO].concat(
  (PHOTOS[AGANTA_BLACK_UID] || []).filter((url) =>
    url !== AGANTA_BLACK_PHOTO && !AGANTA_BLACK_SUPERSEDED.includes(url)
  )
);
